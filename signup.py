...
entry3= customtkinter.CTkEntry(master=frame,placeholder_text="Email",width=200)
entry3.pack(pady=(0,15))
...
SignUp_text = customtkinter.CTkLabel(master= frame,text="Already a Member. Click Here To Login")
SignUp_text.pack()
